...
#define ASUS_MODELS {   \
	...
	MODELID(MODEL_BD4_OD),\
	MODELID(MODEL_RTBE58U_PRO),\
	MODELID(MODEL_RTBE58_GO),\
	MODELID(MODEL_EBA76),\
	MODELID(MODEL_GTBE19000AI),\
	MODELID(MODEL_RTBE50),\
	MODELID(MODEL_GS7),\
	MODELID(MODEL_RT4GBE58),\
	MODELID(MODEL_TUFBE9400),\
	MODELID(MODEL_K3),\
	...
	MODELID(MODEL_S20PAX6000),\
	MODELID(MODEL_UNR030N),\
	MODELID(MODEL_XMCR660X),\
	MODELID(MODEL_JCGQ20),\
	MODELID(MODEL_SWRT360T7),\
	MODELID(MODEL_CMCCA9),\
	MODELID(MODEL_XMAX3600),\
	MODELID(MODEL_RAX40),\
	MODELID(MODEL_JDCAX3000),\
	MODELID(MODEL_JDCAX6600),\
	MODELID(MODEL_MAX)\
}
