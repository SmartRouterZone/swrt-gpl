...
#include <netinet/ether.h>	//struct ether_XXX()
#endif
#ifndef _LINUX_IF_H
#include <net/if.h>
#endif
...
#ifdef CONFIG_BCMWL5
#if defined(RTAX56_XD4) || defined(XD4PRO) || defined(CTAX56_XD4) || defined(BT12) || defined(BQ16)|| defined(XC5) || defined(EBA63)
...
enum led_id {
 ...
 && (defined(RTAX89U) || defined(GTAXY16000) || defined(BR63) || defined(RAX120))
	PWR_USB2,
#endif
	...
	IND_PA,
#endif
#if defined(RTAX82U) || defined(DSL_AX82U) || defined(GSAX3000) || defined(GSAX5400) || defined(TUFAX5400) || defined(GTAX11000_PRO) || defined(GTAXE16000) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTAX6000) || defined(GT10) || defined(RTAX82U_V2) || defined(TUFAX5400_V2) || defined(GTBE96)
	LED_GROUP1_RED,
	LED_GROUP1_GREEN,
	LED_GROUP1_BLUE,
	...
	LED_WIFI,
#endif
#if defined(GTAXE16000) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTAX11000_PRO) || defined(GTBE96)
	LED_WAN_RGB_RED,
	LED_WAN_RGB_GREEN,
	LED_WAN_RGB_BLUE,
	LED_10G_RGB_RED,
...
#elif defined(RTCONFIG_HAS_5G_2) || ((defined(RTCONFIG_QCA) || defined(RTCONFIG_RALINK)) && (defined(RTCONFIG_WIFI6E) || (defined(RTCONFIG_WIFI7) && !defined(RTCONFIG_WIFI7_NO_6G))))
...
enum wl_band_id {
#if defined(GTAXE16000) || defined(GTBE98) || defined(EBG15) || defined(EBG19)
	WL_5G_BAND = 0,
	WL_5G_2_BAND = 1,
	WL_6G_BAND = 2,
	WL_2G_BAND = 3,
...
enum wl_bandwidth_id {
	...
	WL_BW_6480 = 12,	/* 60G: 6.48GHz */
	WL_BW_8640 = 13,	/* 60G: 8.64GHz */
...
extern int is_iot_ifname(const char *ifname);
extern int iot_exists(void);
#endif
...
#ifdef RTCONFIG_MLO
extern int init_mld_macaddr(void);
extern int get_mldphy(char* phyname, int band);
extern int create_mld_vap(void);
extern int destroy_mld_vap(void);
extern int mld_iface(int unit,char *iface);
extern char *get_ap_hwaddr(int unit, int sub);
extern char *get_apg_br_by_vid(int vid);
extern int chk_mlo_sdn(int sdn_idx);
extern int chk_mlo_enable_by_sdn_wif(char* wif);
...
#endif
extern int get_max_bw_by_chlist(int band, uint64_t avbl_ch_mask);
extern int acs_and_change_bw_if_need(int band, const char *vap, uint64_t avbl_ch_mask);
...
/* sysdeps/ralink/ *.c */
 ...
 || defined(RTCONFIG_MT798X) || defined(RTCONFIG_MT799X) || defined(RTCONFIG_RALINK_MT7621)
...
#endif
#if defined(RTAX55) || defined(RTAX1800) || defined(RTCONFIG_EXT_RTL8365MB) || defined(RTCONFIG_EXT_RTL8370MB) || defined(RTAX58U_V2) || defined(RTAX3000N) || defined(BR63) || defined(GTBE98) || defined(GTBE98_PRO) || defined(EBG19) || defined(GTBE96)
...
#endif
#ifdef HND_ROUTER
#if defined(RTAX55) || defined(RTAX1800) || defined(RTAX58U_V2) || defined(RTAX3000N) || defined(BR63) || defined(GTBE98) || defined(GTBE98_PRO) || defined(EBG19) || defined(GTBE96)
...
extern int read_phy_reg(unsigned int phy, unsigned int reg);
extern int write_phy_reg(unsigned int phy, unsigned int reg, unsigned int value);
#elif defined(RTCONFIG_SWITCH_QCA8075_PHY_AQR111)
extern int is_aqr_phy_exist(void);
extern int aqr_phy_addr(void);
extern int parse_ssdk_sh(const char *cmd, const char *fmt, int cnt, ...);
extern int read_phy_reg(unsigned int phy, unsigned int reg);
...
#endif
#if defined(RTCONFIG_WLMODULE_MT7615E_AP) || defined(RT4GAC86U) || defined(RTACRH18) || defined(RT4GAX56)
...
#else
#if defined(RTCONFIG_SOC_IPQ60XX) || defined(RTCONFIG_SOC_IPQ50XX) || defined(RTCONFIG_MT798X) || defined(RTCONFIG_MT799X)
extern const char *vport_to_iface_name(unsigned int vport);
#else
...
#if defined(PLAX56_XP4) || defined(RTAX59U) 
#define RGBLED_WHITE			RGBLED_COLOR_MESK
#elif defined(PRTAX57_GO)
#define RGBLED_WHITE			RGBLED_WLED
#else
...
extern int gen_uplinkport_describe(char *port_def, char *type, char *subtype, int index);
#endif
extern int get_type_by_channel(int nbandnum, int nbandn);
extern int get_bandnum_by_nband(int num);
extern void check_wlx_nband_type();
extern int check_band_use_by_channel_set(int unit);
extern int check_band_use_by_channel_plan(int unit, int band);
extern void set_channel_by_manual();
...
#if defined(RTAX82U) || defined(DSL_AX82U) || defined(GSAX3000) || defined(GSAX5400) || defined(TUFAX5400) || defined(GTAX11000_PRO) || defined(GTAXE16000) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTAX6000) || defined(GT10) || defined(RTAX82U_V2) || defined(TUFAX5400_V2) || defined(TUFAX6000) || defined(GTBE96)
#define LEDG_OFF			0
...
enum {
#if defined(GTAXE16000) || defined(GTBE98)
	WLIF_2G	 = 3,
	WLIF_5G1 = 0,
	WLIF_5G2 = 1,
	WLIF_6G	 = 2,
