...
function initial(){
	...
	if(bcm_mumimo_support){
		...
		else if ((based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BQ16' || based_modelid == 'BQ16_PRO' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'RT-AXE95Q' || based_modelid == 'ET8PRO' || based_modelid == 'ET8_V2' || based_modelid == 'RT-AX56_XD4' || based_modelid == 'XD4PRO' || based_modelid == 'CT-AX56_XD4' || based_modelid == 'RT-AX56U' || based_modelid == "RP-AX56" || based_modelid == "RP-AX58" || based_modelid == 'XC5' || based_modelid == "EBA63") && (is_unit_24g(wl_unit_value) || is_unit_5g(wl_unit_value))){
			document.getElementById("wl_MU_MIMO_field").style.display = "none";
			document.form.wl_mumimo.disabled = true;
		}
...
function adjust_tx_power(){
	var custompower = Bcmwifi_support ? parseInt(document.form.wl_cpenable.value) : 0;
...
function adjust_custom_power(){
	if(Bcmwifi_support){
		...
		document.getElementById("wl_chPower_field").style.display = "";
		if(custompower == 0){
...
-->
					...
					<tr id="wl_chPower_field" style="display:none">
					...
					<tr id="wl_custompower_field" style="display:none">
